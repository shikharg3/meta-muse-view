 ...
 * trace.ts sits beside MessageMeta.tsx.
 *
...
/**
 * A single question above this reads as expensive. Measured: the median question is ~$0.11, so $0.25
 * means the thread it sits in has already grown enough to be worth noticing.
 */
export const HIGH_TURN_COST = 0.25;
