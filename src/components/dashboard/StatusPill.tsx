...
const styles: Record<string, string> = {
  ...
  // Ad delivery (`effective_status`). The *_PAUSED states fall through to PAUSED.
  DISAPPROVED: "bg-destructive/10 text-destructive ring-destructive/20",
  WITH_ISSUES: "bg-destructive/10 text-destructive ring-destructive/20",
  PENDING_REVIEW: "bg-warning/10 text-warning ring-warning/20",
  IN_PROCESS: "bg-warning/10 text-warning ring-warning/20",
  PENDING_BILLING_INFO: "bg-warning/10 text-warning ring-warning/20",
...
const dots: Record<string, string> = {
  ...
  WITH_ISSUES: "bg-destructive",
  PENDING_REVIEW: "bg-warning",
  IN_PROCESS: "bg-warning",
  PENDING_BILLING_INFO: "bg-warning",
